import { MatchEntity, STADIUM_COST_PER_SEAT, STADIUM_DEMOLISH_REFUND_RATE, StadiumEntity } from '@goalxi/database';
...
describe('StadiumService — §5.3 summary & rename', () => {
    ...
    describe('getSummary', () => {
        it('should return summary with cost and refund', async () => {
            stadiumRepository.findOne.mockResolvedValue(mockStadium({ capacity: 10000 }));
            ...
            expect(summary).toMatchObject({
                ...
                demolishRefund: Math.floor(10000 * STADIUM_COST_PER_SEAT * STADIUM_DEMOLISH_REFUND_RATE),
            });
        });
