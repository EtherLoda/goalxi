...
export function getRandomNameByNationality(nationality: string): {
  ...
  if (!database) {
    ...
    return {
      firstName:
        fallback.firstNames[
          Math.floor(Math.random() * fallback.firstNames.length)
        ],
      lastName:
        fallback.lastNames[
          Math.floor(Math.random() * fallback.lastNames.length)
        ],
    };
  }
  ...
  return {
    firstName:
      database.firstNames[
        Math.floor(Math.random() * database.firstNames.length)
      ],
    lastName:
      database.lastNames[Math.floor(Math.random() * database.lastNames.length)],
  };
}
