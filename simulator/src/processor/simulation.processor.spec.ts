...
describe('SimulationProcessor', () => {
    ...
    const mockHomeTactics = {
        ...
        teamId: 'team-1',
        formation: '4-4-2',
        lineup: { GK: 'p1', CD: 'p2', LB: 'p3', RB: 'p4', CM: 'p5', LW: 'p6', RW: 'p7', AM: 'p8', CF: 'p9', CD2: 'p10', CD3: 'p11' },
        substitutions: [],
        instructions: {},
    };
    ...
    const mockAwayTactics = {
        ...
        teamId: 'team-2',
        formation: '4-3-3',
        lineup: { GK: 'p12', CD: 'p13', LB: 'p14', RB: 'p15', CM: 'p16', LW: 'p17', RW: 'p18', AM: 'p19', CF: 'p20', CD2: 'p21', CD3: 'p22' },
        substitutions: [],
        instructions: {},
    };
    ...
    const mockPlayers = Array.from({ length: 22 }, (_, i) => ({
        ...
        name: `Player ${i + 1}`,
        currentSkills: {
            pace: 70, strength: 70, stamina: 80, jumping: 70,
            finishing: 70, longShots: 70, composure: 70, positioning: 70,
            passing: 70, dribbling: 70, crossing: 70, tackling: 70,
            marking: 70, gk_reflexes: 70, gk_handling: 70,
        },
            currentStamina: 3,
            form: 5,
            experience: 10,
