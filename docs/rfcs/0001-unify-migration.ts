...
export class UnifyYouthIntoPlayer1722000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      SELECT
        yp."id",
        (('x' || substr(md5(yp."id"::text), 1, 16))::bit(64)::bigint)::text,
        yp."name",
        yp."nationality",
        yp."is_goalkeeper",
        true,
    ...
    await queryRunner.query(`
      INSERT INTO "match" (
        "id", "league_id", "season", "week", "round",
        ...
        "has_penalty_shootout", "youth_league_id", "stadium_id",
        "weather", "attendance", "lower_league_id", "created_at", "updated_at"
      )
      SELECT
        ym."id",
        NULL,
