...
import { PlayerEntity, StaffEntity, TeamEntity, applyTrainingToPlayer } from '@goalxi/database';
...
export class TrainingProcessor extends WorkerHost {
    ...
    async process(job: Job<any, any, string>): Promise<any> {
        this.logger.log('[TrainingProcessor] Starting training settlement processing...');
    ...
    onFailed(job: Job, err: Error) {
        this.logger.error(`Training settlement job ${job.id} failed: ${err.message}`);
    }
}
