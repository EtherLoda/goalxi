...
describe('WeatherSchedulerService', () => {
  ...
  describe('generateDailyWeather', () => {
    it('should call weatherService.createOrUpdateTodayWeather', async () => {
      ...
      mockWeatherService.createOrUpdateTodayWeather.mockResolvedValue(
      ...
      expect(
        mockWeatherService.createOrUpdateTodayWeather,
    ...
    it('should handle errors gracefully', async () => {
      ...
      expect(loggerErrorSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          'Failed to generate weather: Database connection failed',
        ),
      );
    });

    it('should not throw when weather generation fails', async () => {
      mockWeatherService.createOrUpdateTodayWeather.mockRejectedValue(
        new Error('DB error'),
      );
