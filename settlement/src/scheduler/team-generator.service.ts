...
const POSITION_TEMPLATES: Record<string, Record<TemplateType, {
    ...
    GK: {
        elite: { primary: ['gk_reflexes', 'gk_handling'], secondary: ['positioning', 'composure'], tertiary: ['passing', 'strength', 'pace'] },
        balanced: { primary: ['gk_reflexes', 'gk_handling'], secondary: ['positioning', 'composure', 'strength'], tertiary: ['passing', 'pace'] },
        rookie: { primary: ['gk_handling'], secondary: ['gk_reflexes', 'positioning'], tertiary: ['composure', 'strength', 'passing', 'pace'] },
        specialized: { primary: ['gk_handling'], secondary: ['gk_reflexes', 'positioning'], tertiary: ['composure', 'strength', 'passing'] },
    },
    CD: {
        elite: { primary: ['defending', 'strength', 'positioning'], secondary: ['pace', 'composure'], tertiary: ['passing', 'finishing', 'dribbling'], abilities: ['tackle_master'] },
        balanced: { primary: ['defending', 'strength'], secondary: ['positioning', 'pace'], tertiary: ['composure', 'passing'] },
        rookie: { primary: ['defending', 'strength'], secondary: ['positioning', 'pace'], tertiary: ['composure', 'passing'] },
        specialized: { primary: ['strength', 'positioning'], secondary: ['defending', 'pace'], tertiary: ['composure', 'passing'] },
    },
    LB: {
        elite: { primary: ['defending', 'pace', 'composure'], secondary: ['strength', 'positioning', 'passing'], tertiary: ['dribbling', 'finishing'], abilities: ['tackle_master'] },
        balanced: { primary: ['defending', 'pace'], secondary: ['strength', 'positioning'], tertiary: ['composure', 'passing'] },
        rookie: { primary: ['defending', 'pace'], secondary: ['strength', 'positioning'], tertiary: ['composure', 'passing'] },
        specialized: { primary: ['pace', 'passing'], secondary: ['dribbling', 'positioning'], tertiary: ['defending', 'strength'] },
    },
    RB: {
        elite: { primary: ['defending', 'pace', 'composure'], secondary: ['strength', 'positioning', 'passing'], tertiary: ['dribbling', 'finishing'], abilities: ['tackle_master'] },
        balanced: { primary: ['defending', 'pace'], secondary: ['strength', 'positioning'], tertiary: ['composure', 'passing'] },
    ...
    DM: {
        elite: { primary: ['passing', 'defending', 'positioning'], secondary: ['composure', 'strength', 'pace'], tertiary: ['dribbling', 'finishing'], abilities: ['tackle_master', 'counter_starter'] },
        balanced: { primary: ['passing', 'defending'], secondary: ['positioning', 'strength'], tertiary: ['composure', 'pace'] },
        rookie: { primary: ['passing', 'defending'], secondary: ['positioning', 'strength'], tertiary: ['composure', 'pace'] },
        specialized: { primary: ['positioning', 'strength'], secondary: ['defending', 'pace'], tertiary: ['passing', 'composure'] },
    },
    CM: {
        elite: { primary: ['passing', 'dribbling', 'positioning'], secondary: ['defending', 'composure', 'pace'], tertiary: ['strength', 'finishing'], abilities: ['long_passer', 'counter_starter'] },
        balanced: { primary: ['passing', 'dribbling'], secondary: ['positioning', 'defending'], tertiary: ['composure', 'strength', 'pace'] },
        rookie: { primary: ['passing', 'dribbling'], secondary: ['positioning', 'defending'], tertiary: ['composure', 'strength', 'pace'] },
        specialized: { primary: ['passing'], secondary: ['positioning', 'composure'], tertiary: ['dribbling', 'defending', 'pace'] },
    },
    AM: {
        elite: { primary: ['passing', 'dribbling', 'finishing'], secondary: ['positioning', 'composure', 'pace'], tertiary: ['defending', 'strength'], abilities: ['long_passer', 'clutch_player'] },
        balanced: { primary: ['passing', 'dribbling'], secondary: ['finishing', 'positioning'], tertiary: ['composure', 'pace'] },
        rookie: { primary: ['passing', 'dribbling'], secondary: ['finishing', 'positioning'], tertiary: ['composure', 'pace'] },
        specialized: { primary: ['finishing', 'positioning'], secondary: ['pace', 'composure'], tertiary: ['passing', 'dribbling'] },
    },
    LW: {
        elite: { primary: ['pace', 'dribbling', 'passing'], secondary: ['finishing', 'positioning'], tertiary: ['strength', 'defending', 'composure'], abilities: ['dribble_master', 'cross_specialist', 'fast_start'] },
        balanced: { primary: ['pace', 'dribbling'], secondary: ['passing', 'finishing'], tertiary: ['positioning', 'strength'] },
        rookie: { primary: ['pace', 'dribbling'], secondary: ['passing', 'finishing'], tertiary: ['positioning', 'strength'] },
        specialized: { primary: ['pace', 'passing'], secondary: ['cross_specialist', 'positioning'], tertiary: ['dribbling', 'finishing'] },
    },
    RW: {
        elite: { primary: ['pace', 'dribbling', 'passing'], secondary: ['finishing', 'positioning'], tertiary: ['strength', 'defending', 'composure'], abilities: ['dribble_master', 'cross_specialist', 'fast_start'] },
        balanced: { primary: ['pace', 'dribbling'], secondary: ['passing', 'finishing'], tertiary: ['positioning', 'strength'] },
    ...
    CF: {
        elite: { primary: ['finishing', 'positioning', 'strength'], secondary: ['pace', 'composure', 'dribbling'], tertiary: ['passing', 'defending'], abilities: ['clutch_player', 'rebound_specialist', 'header_specialist'] },
        balanced: { primary: ['finishing', 'positioning'], secondary: ['strength', 'pace'], tertiary: ['composure', 'dribbling', 'passing'] },
        rookie: { primary: ['finishing', 'positioning'], secondary: ['strength', 'pace'], tertiary: ['composure', 'dribbling', 'passing'] },
        specialized: { primary: ['positioning', 'strength'], secondary: ['finishing', 'pace'], tertiary: ['composure', 'dribbling'], abilities: ['header_specialist'] },
    },
};
...
export class TeamGeneratorService {
    ...
    private generateSkills(position: string, skillBase: number, templateType: TemplateType): any {
        ...
        if (position === 'GK') {
            return {
                ...
                technical: {
                    reflexes: skill(base, template?.elite?.primary?.includes('gk_reflexes') ? 3 : template?.balanced?.primary?.includes('gk_reflexes') ? 2 : 0, randVariance()),
                    handling: skill(base, template?.elite?.primary?.includes('gk_handling') ? 3 : template?.balanced?.primary?.includes('gk_handling') ? 2 : 0, randVariance()),
                    distribution: skill(base, -4, randVariance()),
                },
                mental: {
                    positioning: skill(base, template?.elite?.secondary?.includes('positioning') ? 2 : template?.balanced?.secondary?.includes('positioning') ? 1 : -1, randVariance()),
                    composure: skill(base, template?.elite?.secondary?.includes('composure') ? 2 : template?.balanced?.secondary?.includes('composure') ? 1 : -1, randVariance()),
                },
                setPieces: {
    ...
    private generateAge(): number {
        ...
        if (rand < 0.70) return this.randomInRange(22, 26);
        if (rand < 0.90) return this.randomInRange(27, 30);
